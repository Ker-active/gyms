  ...
  return (
    <article className='flex bg-white px-[20px] gap-[30px] py-[24px] rounded-[8px] flex-col '>
      ...
      <div className='flex flex-col'>
        <h3 className='text-[#1C1939] leading-[50px]  font-inter'>
          Not on the list? simply type into the box below
        </h3>

        <Input
          placeholder='Add new service'
          className={
            "text-sm border h-[37px] w-[200px]  rounded-full text-[#909090] py-[9px] px-[24.5px]"
          }
          type='text'
          value={inputValue}
