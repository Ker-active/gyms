...
import { AddReview, ListInfo, ReviewComponent, SectionSocialMedia, Trainers } from "@/components/shared";
      ...
      <section className="flex pb-40 sm:pb-0  flex-col gap-[40px]">
        <section className="bg-white flex flex-col lg:flex-row gap-4 lg:gap-8 xl:gap-[50px] px-[23px] py-[34px] rounded-[10px]">
          ...
          <article className="flex flex-col w-full gap-[22px]">
            <header>
              <h2 className="text-[#1C1939] font-bold text-lg lg:text-2xl">Wisdom Ikpeama</h2>
